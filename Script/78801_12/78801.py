...
repository_path = './script/78801_12/'
pert_mat_file = '78801_12.mat'
patch_mat_file = './script/78801_12/78801_patch_120_HeI_667.mat'
...
tpc,tri,emi= tomo(f"{patch_mat_file}",ax=ax,emi_vmin=0, emi_vmax=6e18)
