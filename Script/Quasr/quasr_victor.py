...
gs = GridSpec(2, 3, wspace=0.2, hspace=0.2, width_ratios=[1, 1, 1.2], height_ratios=[1.1, 1])
...
jsonname = 'Script/ResonnanceZone/serial0229079.json'
...
manifold8a_in.save('./Script/Quasr/manifolds/8a_in.pkl')


#manifold8a_in  = Manifold.load("./Script/Quasr/manifolds/8a_in.pkl")
...
manifold8a_out.save('./Script/Quasr/manifolds/8a_out.pkl')


#manifold8a_out  = Manifold.load("./Script/Quasr/manifolds/8a_out.pkl")
...
manifold8b_in.save('./Script/Quasr/manifolds/8b_in.pkl')


#manifold8b_in  = Manifold.load("./Script/Quasr/manifolds/8b_in.pkl")
...
manifold8b_out.save('./Script/Quasr/manifolds/8b_out.pkl')


#manifold8b_out  = Manifold.load("./Script/Quasr/manifolds/8b_out.pkl")
...
manifold9_in.save('./Script/Quasr/manifolds/9_in.pkl')


#manifold9_in  = Manifold.load("./Script/Quasr/manifolds/9_in.pkl")
...
manifold9_out.save('./Script/Quasr/manifolds/9_out.pkl')


#manifold9_out  = Manifold.load("./Script/Quasr/manifolds/9_out.pkl")
...
manifold10_in.save('./Script/Quasr/manifolds/10_in.pkl')


#manifold10_in  = Manifold.load("./Script/Quasr/manifolds/10_in.pkl")
...
manifold11_in.save('./Script/Quasr/manifolds/11_in.pkl')


#manifold11_in  = Manifold.load("./Script/Quasr/manifolds/11_in.pkl")
...
manifold11_out.save('./Script/Quasr/manifolds/11_out.pkl')

#manifold11_out  = Manifold.load("./Script/Quasr/manifolds/11_out.pkl")
...
crazymanifold.save('./Script/Quasr/manifolds/crazymanifold.pkl')

#manifold11_out  = Manifold.load("./Script/Quasr/manifolds/crazymanifold.pkl")
