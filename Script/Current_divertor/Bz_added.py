...
# manifold_1T.compute(
#    eps_s=9e-6, eps_u=8e-6, nint_s=17, nint_u=17, neps_s=80, neps_u=240) #8 14 240
...
#manifold_init = Manifold.load(f"{repository_path}/manifolds_P/mf_1T.pkl")
...
ax.set_ylabel(r"$Z[m]$")
ax.set_aspect('equal') 
ax.set_title('(77062 / 1.2s), added Bz=0.017 [T]')
