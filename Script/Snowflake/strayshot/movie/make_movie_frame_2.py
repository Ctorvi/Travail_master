...
def plot_perturbed_manifolds(angle, frame_index=0):
    ...
    SFField = AxisymmetricCylindricalGridField.from_matlab_file('./Script/Snowflake/Snowflake_09.mat', with_perturbation=True)
    ...
    plt.savefig(f"./Script/Snowflake/movie/movie_frames_annotated/pertmovie_{frame_index:03d}.png", bbox_inches='tight', dpi=720)
