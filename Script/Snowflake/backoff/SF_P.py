...
section = CylindricalBfieldSection(JFField,phi0=4.38,R0=0.88, Z0=0)
...
# tpc= tomo(f"{patch_mat_file}",ax,emi_vmin=0, emi_vmax=1.6e18)
...
manifold_1T.plot(stepsize_limit=0.1, ax=ax, markersize=0, lw=1,colors=["magenta", "xkcd:red"],labels=["Stable MF 1T","Unstable MF 1T"])
manifold_1B.plot(stepsize_limit=0.3, ax=ax, markersize=0, lw=0.7,colors=["magenta", "xkcd:red"],labels=[None,None])
manifold_2T.plot(stepsize_limit=0.1, ax=ax, markersize=0, lw=0.7,colors=["magenta", "xkcd:red"],labels=[None,None])
manifold_2B.plot(stepsize_limit=0.3, ax=ax, markersize=0, lw=0.7,colors=["magenta", "xkcd:red"],labels=[None,None])


top_o.plot(ax=ax, marker='o',s=40, color="xkcd:white",label='O-points', zorder=10)
x_point1.plot(ax=ax, marker='x', s=50, color="xkcd:white",label='X-points', zorder=10)
x_point2.plot(ax=ax, marker='x', s=50, color="xkcd:white",label=None, zorder=10)
...
ax.legend(loc='lower right', bbox_to_anchor=(1., 0.0), ncol=2, fontsize=9)
