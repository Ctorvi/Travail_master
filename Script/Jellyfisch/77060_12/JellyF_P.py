...
JFField = AxisymmetricCylindricalGridField.from_matlab_file('./Script/Jellyfisch/77060_12/Jellyfisch_77060_12_Backoff.mat', with_perturbation=True)
...
data = loadmat('./Script/Jellyfisch/77060_12/JF_patch_77060_12.mat', squeeze_me=True, struct_as_record=False)
...
# manifold_1T.save('./Script/Jellyfisch/77060_12/manifolds_P/mf_1T.pkl')
...
# manifold_1B.save('./Script/Jellyfisch/77060_12/manifolds_P/mf_1B.pkl')
...
# manifold_2T.save('./Script/Jellyfisch/77060_12/manifolds_P/mf_2T.pkl')
...
# manifold_2B.save('./Script/Jellyfisch/77060_12/manifolds_P/mf_2B.pkl')
...
# manifold_3L.compute(
#       eps_s=9e-6, eps_u=8e-6, nint_s=40, nint_u=40, neps_s=80, neps_u=80)
# manifold_3L.save('./Script/Jellyfisch/77060_12/manifolds_P/mf_3L.pkl')
...
# manifold_3R.compute(
#       eps_s=9e-6, eps_u=8e-6, nint_s=40, nint_u=40, neps_s=80, neps_u=80)
# manifold_3R.save('./Script/Jellyfisch/77060_12/manifolds_P/mf_3R.pkl')





manifold_1T  = Manifold.load("./Script/Jellyfisch/77060_12/manifolds_P/mf_1T.pkl")
manifold_1B  = Manifold.load("./Script/Jellyfisch/77060_12/manifolds_P/mf_1B.pkl")
manifold_2T  = Manifold.load("./Script/Jellyfisch/77060_12/manifolds_P/mf_2T.pkl")
manifold_2B  = Manifold.load("./Script/Jellyfisch/77060_12/manifolds_P/mf_2B.pkl")
manifold_3L = Manifold.load("./Script/Jellyfisch/77060_12/manifolds_P/mf_3L.pkl")
manifold_3R  = Manifold.load("./Script/Jellyfisch/77060_12/manifolds_P/mf_3R.pkl")
...
# ax.set_ylabel(r"$Z[m]$")
# ax.set_aspect('equal') 
# ax.set_title('77060 at 1.2s, at 1.9 rad')
# plt.savefig('./Script/Jellyfisch/77060_12/figures/Jellyfisch_BO_Pert_mf_patch.png', bbox_inches='tight', dpi=720)
# plt.show()
...
ax.set_aspect('equal') 
ax.set_title('77060 at 1.2s, at 1.9 rad')
plt.savefig('./Script/Jellyfisch/77060_12/figures/Jellyfisch_BO_Pert_mf_patch_zoom.png', bbox_inches='tight', dpi=720)
plt.show()
