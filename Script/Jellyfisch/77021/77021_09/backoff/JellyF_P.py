...
JFField = AxisymmetricCylindricalGridField.from_matlab_file('./Script/Jellyfisch/77021/77021_09/backoff/Jellyfisch_09_Backoff.mat', with_perturbation=True)
...
data = loadmat('./Script/Jellyfisch/77021/77021_09/backoff/JF_patch_77021_09.mat', squeeze_me=True, struct_as_record=False)
...
tpc=ax.tripcolor(tri, emi, shading='flat', edgecolors='none', vmin=0, vmax=4e20)
...
# manifold_1T.save('./Script/Jellyfisch/77021_09/backoff/manifolds_P/mf_1T.pkl')


manifold_1T  = Manifold.load("./Script/Jellyfisch/77021/77021_09/backoff/manifolds_P/mf_1T.pkl")

manifold_1T.plot(stepsize_limit=0.2, ax=ax, markersize=0, lw=0.7)
...
# manifold_1B.save('./Script/Jellyfisch/77021_09/backoff/manifolds_P/mf_1B.pkl')


manifold_1B  = Manifold.load("./Script/Jellyfisch/77021/77021_09/backoff/manifolds_P/mf_1B.pkl")


manifold_1B.plot(ax=ax, markersize=0, lw=0.7)
...
# manifold_2T.save('./Script/Jellyfisch/77021_09/backoff/manifolds_P/mf_2T.pkl')


manifold_2T  = Manifold.load("./Script/Jellyfisch/77021/77021_09/backoff/manifolds_P/mf_2T.pkl")
...
# manifold_2B.save('./Script/Jellyfisch/77021_09/backoff/manifolds_P/mf_2B.pkl')


manifold_2B  = Manifold.load("./Script/Jellyfisch/77021/77021_09/backoff/manifolds_P/mf_2B.pkl")
...
# manifold_3L.compute(
#       eps_s=9e-6, eps_u=8e-6, nint_s=40, nint_u=40, neps_s=80, neps_u=80)
# manifold_3L.save('./Script/Jellyfisch/77021_09/backoff/manifolds_P/mf_3L.pkl')


manifold_3L = Manifold.load("./Script/Jellyfisch/77021/77021_09/backoff/manifolds_P/mf_3L.pkl")
...
# manifold_3R.compute(
#       eps_s=9e-6, eps_u=8e-6, nint_s=40, nint_u=40, neps_s=80, neps_u=80)
# manifold_3R.save('./Script/Jellyfisch/77021_09/backoff/manifolds_P/mf_3R.pkl')


manifold_3R  = Manifold.load("./Script/Jellyfisch/77021/77021_09/backoff/manifolds_P/mf_3R.pkl")
...
# manifold_4T.compute(
#       eps_s=9e-6, eps_u=8e-6, nint_s=40, nint_u=40, neps_s=80, neps_u=80)
# manifold_4T.save('./Script/Jellyfisch/77021_09/backoff/manifolds_P/mf_4T.pkl')


manifold_4T = Manifold.load("./Script/Jellyfisch/77021/77021_09/backoff/manifolds_P/mf_4T.pkl")
...
# manifold_4B.compute(
#       eps_s=9e-6, eps_u=8e-6, nint_s=40, nint_u=40, neps_s=80, neps_u=80)
# manifold_4B.save('./Script/Jellyfisch/77021_09/backoff/manifolds_P/mf_4B.pkl')


manifold_4B  = Manifold.load("./Script/Jellyfisch/77021/77021_09/backoff/manifolds_P/mf_4B.pkl")
...
ax.set_ylabel(r"$Z[m]$")
ax.set_aspect('equal') 
ax.set_title('77021 at 0.9 s')
plt.savefig('./Script/Jellyfisch/77021/77021_09/backoff/figures/Jellyfisch_BO_Pert_mf_patch.png', bbox_inches='tight', dpi=720)
plt.show()
