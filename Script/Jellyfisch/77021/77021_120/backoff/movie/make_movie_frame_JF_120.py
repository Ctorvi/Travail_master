...
def plot_perturbed_manifolds(angle, frame_index=0):
    ...
    JFField = AxisymmetricCylindricalGridField.from_matlab_file('./Script/Jellyfisch/77021_120/backoff/Jellyfisch_120_Backoff.mat', with_perturbation=True)
...
#plt.figure()
    ...
    plt.savefig(f"./Script/Jellyfisch/77021_120/backoff/movie/movie_frames_annotated/pertmovie_{frame_index:03d}.png", bbox_inches='tight', dpi=720)
