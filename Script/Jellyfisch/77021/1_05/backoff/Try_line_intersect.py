...
repository_path = './script/jellyfisch/77021/1_05/backoff/'
pert_mat_file = 'JF_77021_105.mat'
patch_mat_file = './script/jellyfisch/77021/1_05/JF_patch_77021_105_C3.mat'
...
tpc=ax1.tripcolor(tri, emi, shading='flat', edgecolors='none', vmin=0, vmax=3.e20)
...
ax1.set_title('(77021 / 1.05 s / 1.9 rad)')
...
p0 = np.array([0.86, -0.32])
p1 = x_point2.coords[0]

pts, emi_vals,dist,perio_MANTIS,std_perio_MANTIS= sample_emi_along_line(p0, p1, tri, emi, n_samples=400,ax=ax2)
...
plt.savefig(f"{repository_path}figures/Jellyfisch_77021_periodicity.png", dpi=150, bbox_inches=None, facecolor=fig.get_facecolor())
plt.show()
