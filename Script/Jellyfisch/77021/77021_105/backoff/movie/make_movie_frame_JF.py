...
def plot_perturbed_manifolds(angle, frame_index=0):
    ...
    JFField = AxisymmetricCylindricalGridField.from_matlab_file('./Script/Jellyfisch/77021/77021_105/backoff/Jellyfisch_105_Backoff.mat', with_perturbation=True)
    ...
    data = loadmat('./Script/Jellyfisch/77021/77021_105/JF_patch.mat', squeeze_me=True, struct_as_record=False)
...
#plt.figure()
    ...
    plt.savefig(f"./Script/Jellyfisch/77021/77021_105/backoff/movie/movie_frames_annotated/pertmovie_{frame_index:03d}.png", bbox_inches='tight', dpi=720)
