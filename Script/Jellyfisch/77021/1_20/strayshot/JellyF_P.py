...
JFField = AxisymmetricCylindricalGridField.from_matlab_file('./Script/Jellyfisch/77021_120/Jellyfisch_120.mat', with_perturbation=True)

JFField.set_perturbation_amplitude(2.0)
...
data = loadmat('./Script/Jellyfisch/77021_120/JF_patch_120.mat', squeeze_me=True, struct_as_record=False)
...
tpc=ax.tripcolor(tri, emi, shading='flat', edgecolors='none', vmin=0, vmax=5e20)
...
#manifold_1T.save('./Script/Jellyfisch/77021_120/manifolds_P/mf_1T.pkl')


#manifold_1T  = Manifold.load("./Script/Jellyfisch/77021_120/manifolds_P/mf_1T.pkl")
...
# manifold_1B.save('./Script/Jellyfisch/77021_120/manifolds_P/mf_1B.pkl')


# manifold_1B  = Manifold.load("./Script/Jellyfisch/77021_120/manifolds_P/mf_1B.pkl")
...
# manifold_2T.save('./Script/Jellyfisch/77021_120/manifolds_P/mf_2T.pkl')


# #manifold_2T  = Manifold.load("./Script/Jellyfisch/77021_120/manifolds_P/mf_2T.pkl")
...
ax.set_ylabel(r"$Z[m]$")
ax.set_aspect('equal') 
#plt.savefig('./Script/Jellyfisch/77021_120/figures/Jellyfisch_Pert_mf_patch.png', bbox_inches='tight', dpi=720)
plt.show()
