...
pert_mat_file = 'Jellyfisch_75979_12.mat'
patch_mat_file = './script/jellyfisch/75979_12/JF_75979_patch_12_He2.mat'
...
tpc=ax.tripcolor(tri, emi, shading='flat', edgecolors='none', vmin=0, vmax=2.25e19)
...
# plt.savefig(f"{repository_path}figures/Jellyfisch_75979_BO_Pert_mf_patch.png", bbox_inches='tight', dpi=720)
# plt.show()
