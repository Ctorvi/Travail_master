...
JFField = AxisymmetricCylindricalGridField.from_matlab_file('./script/jellyfisch/PC_analysis/E coil/pert_files/BO78_only_E4_tilt.mat', with_perturbation=True)
...
# manifold.save('./script/jellyfisch/PC_analysis/E coil/manifolds/mf_E_BO78_E4_tilt.pkl')
...
#manifold  = Manifold.load("./Script/Jellyfisch/PC_analysis/E coil/manifolds/mf_E_8.pkl") ##DX plus  #########
...
#manifold1  = Manifold.load("./Script/Jellyfisch/PC_analysis/E coil/manifolds/mf_E_13.pkl") ##Only E1 to E4  #########
#manifold2 = Manifold.load("./Script/Jellyfisch/PC_analysis/E coil/manifolds/mf_E_14.pkl") ##Only E3 to E4  #########
#manifold1 = Manifold.load("./Script/Jellyfisch/PC_analysis/E coil/manifolds/mf_E_15.pkl") ##Only E5 to E8  #########
#manifold2 = Manifold.load("./Script/Jellyfisch/PC_analysis/E coil/manifolds/mf_E_16.pkl") ##Only E3 #########
#manifold2 = Manifold.load("./Script/Jellyfisch/PC_analysis/E coil/manifolds/mf_E_17.pkl") ##Only E4 #########

manifold1 = Manifold.load("./script/jellyfisch/PC_analysis/E coil/manifolds/mf_E_BO78_E4_tilt.pkl") ##Only E4 #########
manifold2  = Manifold.load("./script/jellyfisch/77021/1_20/backoff/manifolds_P/OS_BO78/mf_1T_n20.pkl") 
...
ax.legend(['E4 st.','E4 unst.','LSE st.', 'LSE unst.'], loc='lower right', fontsize=7)
...
plt.savefig('./script/jellyfisch/PC_analysis/E coil/figures/E4_LSE.png', bbox_inches='tight', dpi=720)
plt.show()
