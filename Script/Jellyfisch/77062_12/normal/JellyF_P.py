...
# manifold_1B.save(f"{repository_path}manifolds_P/OS/mf_1B.pkl")
...
# manifold_2T.save(f"{repository_path}manifolds_P/OS/mf_2T.pkl")

# ### bottom fp bottom mf


# manifold_2B = Manifold(section, x_point2, x_point2,x_point2_coord-top_o_coord, x_point2_coord-top_o_coord)
# manifold_2B.compute(eps_s=9e-6, eps_u=8e-6, nint_s=32, nint_u=32, neps_s=80, neps_u=80)
# manifold_2B.save(f"{repository_path}manifolds_P/OS/mf_2B.pkl")
...
# manifold_3L.save(f"{repository_path}manifolds_P/OS/mf_3L.pkl")
...
# manifold_3R.save(f"{repository_path}manifolds_P/OS/mf_3R.pkl")
...
# manifold_4T.save(f"{repository_path}manifolds_P/OS/mf_4T.pkl")
...
# manifold_4B.save(f"{repository_path}manifolds_P/OS/mf_4B.pkl")
...
# ax.set_title('(77062 / 1.2s / 1.9 rad)')
# plt.savefig(f"{repository_path}figures/JF_77062_120_C3_Zoom.png", dpi=150, bbox_inches=None, facecolor=fig.get_facecolor())
# plt.show()
