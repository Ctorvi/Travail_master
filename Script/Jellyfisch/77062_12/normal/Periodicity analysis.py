...
tpc,tri,emi= tomo(f"{patch_mat_file}",ax=ax1,emi_vmin=0, emi_vmax=9e20)
...
plt.savefig(f"{repository_path}figures/JF_77062_periodicity.png", dpi=150, bbox_inches=None, facecolor=fig.get_facecolor())
plt.show()
