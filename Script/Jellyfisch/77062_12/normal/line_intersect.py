...
tpc=ax1.tripcolor(tri, emi, shading='flat', edgecolors='none', vmin=0, vmax=8.e20)
...
p0 = np.array([0.85, -0.29])
p1 = np.array([0.85, -0.5])  #x_point2.coords[0]
...
plt.savefig(f"{repository_path}figures/Jellyfisch_77062_periodicity.png", dpi=150, bbox_inches=None, facecolor=fig.get_facecolor())
plt.show()
