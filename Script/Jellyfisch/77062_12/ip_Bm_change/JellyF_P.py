...
pert_mat_file = 'JF_77062_120_Bm_Ip_dec.mat'
...
# manifold_2B.save(f"{repository_path}manifolds_dec/mf_2B.pkl")
...
# manifold_1T  = Manifold.load(f"{repository_path}manifolds_inc/mf_1T.pkl")
# manifold_1B  = Manifold.load(f"{repository_path}manifolds_inc/mf_1B.pkl")
# manifold_2T  = Manifold.load(f"{repository_path}manifolds_inc/mf_2T.pkl")
# manifold_2B  = Manifold.load(f"{repository_path}manifolds_inc/mf_2B.pkl")
# manifold_3L = Manifold.load(f"{repository_path}manifolds_inc/mf_3L.pkl")
# manifold_3R  = Manifold.load(f"{repository_path}manifolds_inc/mf_3R.pkl")
# manifold_4T = Manifold.load(f"{repository_path}manifolds_inc/mf_4T.pkl")
# manifold_4B  = Manifold.load(f"{repository_path}manifolds_inc/mf_4B.pkl")
...
manifold_1T  = Manifold.load(f"{repository_path}manifolds_dec/mf_1T.pkl")
manifold_1B  = Manifold.load(f"{repository_path}manifolds_dec/mf_1B.pkl")
manifold_2T  = Manifold.load(f"{repository_path}manifolds_dec/mf_2T.pkl")
manifold_2B  = Manifold.load(f"{repository_path}manifolds_dec/mf_2B.pkl")
manifold_3L = Manifold.load(f"{repository_path}manifolds_dec/mf_3L.pkl")
manifold_3R  = Manifold.load(f"{repository_path}manifolds_dec/mf_3R.pkl")
manifold_4T = Manifold.load(f"{repository_path}manifolds_dec/mf_4T.pkl")
manifold_4B  = Manifold.load(f"{repository_path}manifolds_dec/mf_4B.pkl")
