...
manifold_1T_i.plot(stepsize_limit=0.1, ax=ax1, markersize=0, lw=0.7,colors=["rosybrown", "xkcd:red"],labels=['inc stable','inc unstable'])
manifold_1B_i.plot(stepsize_limit=0.3,ax=ax1, markersize=0, lw=0.7,colors=["rosybrown", "xkcd:red"],labels=[None,None])
manifold_2T_i.plot(stepsize_limit=0.1, ax=ax1, markersize=0, lw=0.7,colors=["rosybrown", "xkcd:red"],labels=[None,None])
manifold_2B_i.plot(stepsize_limit=0.3, ax=ax1, markersize=0, lw=0.7,colors=["rosybrown", "xkcd:red"],labels=[None,None])
manifold_3L_i.plot(stepsize_limit=0.1,ax=ax1, markersize=0, lw=0.7,colors=["rosybrown", "xkcd:red"],labels=[None,None])
manifold_3R_i.plot(ax=ax1, markersize=0, lw=0.7,colors=["rosybrown", "xkcd:red"],labels=[None,None])
manifold_4T_i.plot(ax=ax1, markersize=0, lw=0.7,colors=["rosybrown", "xkcd:red"],labels=[None,None])
manifold_4B_i.plot(ax=ax1, markersize=0, lw=0.7,colors=["rosybrown", "xkcd:red"],labels=[None,None])
...
manifold_1T_d.plot(stepsize_limit=0.1, ax=ax2, markersize=0, lw=0.7,colors=["rosybrown", "xkcd:red"],labels=['dec stable','dec unstable'])
manifold_1B_d.plot(stepsize_limit=0.3,ax=ax2, markersize=0, lw=0.7,colors=["rosybrown", "xkcd:red"],labels=[None,None])
manifold_2T_d.plot(stepsize_limit=0.1, ax=ax2, markersize=0, lw=0.7,colors=["rosybrown", "xkcd:red"],labels=[None,None])
manifold_2B_d.plot(stepsize_limit=0.3, ax=ax2, markersize=0, lw=0.7,colors=["rosybrown", "xkcd:red"],labels=[None,None])
manifold_3L_d.plot(stepsize_limit=0.1,ax=ax2, markersize=0, lw=0.7,colors=["rosybrown", "xkcd:red"],labels=[None,None])
manifold_3R_d.plot(ax=ax2, markersize=0, lw=0.7,colors=["rosybrown", "xkcd:red"],labels=[None,None])
manifold_4T_d.plot(ax=ax2, markersize=0, lw=0.7,colors=["rosybrown", "xkcd:red"],labels=[None,None])
manifold_4B_d.plot(ax=ax2, markersize=0, lw=0.7,colors=["rosybrown", "xkcd:red"],labels=[None,None])
...
top_o_d.plot(ax=ax2, marker='o', color="xkcd:white",label=None,zorder=10)
x_point1_d.plot(ax=ax2, marker='s', color="xkcd:white",label='X-p dec',zorder=10)
x_point2_d.plot(ax=ax2, marker='s', color="xkcd:white",label=None,zorder=10)
x_point3_d.plot(ax=ax2, marker='s', color="xkcd:white",label=None,zorder=10)
x_point4_d.plot(ax=ax2, marker='s', color="xkcd:white",label=None,zorder=10)


top_o_i.plot(ax=ax1, marker='o', color="xkcd:white",label=None,zorder=10)
x_point1_i.plot(ax=ax1, marker='s', color="xkcd:white",label='X-p inc',zorder=10)
x_point2_i.plot(ax=ax1, marker='s', color="xkcd:white",label=None,zorder=10)
x_point3_i.plot(ax=ax1, marker='s', color="xkcd:white",label=None,zorder=10)
x_point4_i.plot(ax=ax1, marker='s', color="xkcd:white",label=None,zorder=10)
...
ax1.legend(loc='upper center', bbox_to_anchor=(0.5, 1), ncol=1, fontsize=9)
...
ax2.legend(loc='upper center', bbox_to_anchor=(0.5, 1), ncol=1, fontsize=9)
ax2.set_title('Ip/Bm decrease vs normal')




plt.savefig(f"{repository_path}figures/comparison_MANTIS_inc_dec.png", bbox_inches='tight', dpi=720)
plt.show()
