...
file_manifolds = 'manifolds_inc/'

mf_list = ['mf_1T', 'mf_1B', 'mf_2T', 'mf_2B', 'mf_3L', 'mf_3R', 'mf_4T', 'mf_4B']

repository_path = './script/jellyfisch/77062_12/ip_Bm_change/'

#pert_mat_file = 'JF_77062_120_Bm_Ip_dec_5.mat'
pert_mat_file = 'JF_77062_120_Bm_Ip_inc_5.mat'
...
ax.set_title('Ip/Bm 0.95 decrease (77062 / 1.2s / 1.9 rad)')
