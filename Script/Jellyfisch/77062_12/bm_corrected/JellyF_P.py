...
repository_path = './Script/Jellyfisch/77062_12/Bm_corrected/'
pert_mat_file = 'JF_77062_12_Bm_corrected.mat'
...
ax.set_title('Bm corrected (77062 / 1.2s / 1.9 rad)')
plt.savefig(f"{repository_path}figures/Jellyfisch_77062_Bm_corrected_zoom.png", dpi=150, bbox_inches=None, facecolor=fig.get_facecolor())
#plt.show()
