...
repository_path = './Script/Jellyfisch/77062_12/Ip_Bm_increase/'
pert_mat_file = 'JF_77062_120_Bm_Ip_inc.mat'
...
plt.savefig(f"{repository_path}figures/Jellyfisch_77062_Ip_Bm_inc.png", bbox_inches='tight', dpi=720)
plt.show()
