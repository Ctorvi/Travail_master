...
JFField = AxisymmetricCylindricalGridField.from_matlab_file('./Script/Jellyfisch/77031/Jellyfisch_77031_105.mat', with_perturbation=True)


section = CylindricalBfieldSection(JFField,R0=0.88, Z0=0)

top_o = FixedPoint(section)
#top_o.find(1, [0.85,0.244], method='scipy.root')
top_o.find(1, [0.85,0.24], method='scipy.root')
...
manifold_1T.compute(
   eps_s=9e-6, eps_u=8e-6, nint_s=8, nint_u=8, neps_s=80, neps_u=80) #8 14 240
...
manifold_1T.plot(ax=ax, markersize=0, lw=0.7)
