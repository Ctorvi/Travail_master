...
The analysis consists of extracting the equilibrium axisymmetric field from a TCV discharge at a specific time from [LIUQUE](https://www.researchgate.net/publication/270825456_Tokamak_equilibrium_reconstruction_code_LIUQE_and_its_real_time_implementation), extracting the :math:n=1n=1n=1 component of the non-axisymmetric perturbation due to coil displacements using a modification of Piras's method. Then compute the Poincaré plot and the manifolds using the method implemented in PyOculus. An homoclinic tangle is forming around the divertor X-point.
